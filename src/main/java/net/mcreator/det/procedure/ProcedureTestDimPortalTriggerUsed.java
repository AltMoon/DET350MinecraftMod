package net.mcreator.det.procedure;
...
public class ProcedureTestDimPortalTriggerUsed extends ElementsDET.ModElement {
	public ProcedureTestDimPortalTriggerUsed(ElementsDET instance) {
		super(instance, 1);
	}

	public static void executeProcedure(java.util.HashMap<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			System.err.println("Failed to load dependency entity for procedure TestDimPortalTriggerUsed!");
			return;
		}
		Entity entity = (Entity) dependencies.get("entity");
		if (!entity.world.isRemote && !entity.isRiding() && !entity.isBeingRidden() && entity instanceof EntityPlayerMP) {
			int dimensionID = WorldTestDim.DIMID;
