...
package net.mcreator.det.world;
...
public class WorldTestDim extends ElementsDET.ModElement {
	public static int DIMID = 3;
	public static final boolean NETHER_TYPE = false;
	@GameRegistry.ObjectHolder("det:testdim_portal")
	public static final BlockCustomPortal portal = null;
	public static DimensionType dtype;
	public WorldTestDim(ElementsDET instance) {
		super(instance, 1);
	}
	...
	public void initElements() {
		...
		elements.items.add(() -> new ItemTestDim().setUnlocalizedName("testdim").setRegistryName("testdim"));
	}
	...
	public void preInit(FMLPreInitializationEvent event) {
		if (DimensionManager.isDimensionRegistered(DIMID)) {
			...
			System.err.println("Dimension ID for dimension testdim is already registered. Falling back to ID: " + DIMID);
		}
		dtype = DimensionType.register("testdim", "_testdim", DIMID, WorldProviderMod.class, true);
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(ItemTestDim.block, 0, new ModelResourceLocation("det:testdim", "inventory"));
	}
				...
				for (int l8 = 0; l8 < 4; ++l8) {
					for (int l9 = -1; l9 < 4; ++l9) {
						...
						this.world.setBlockState(new BlockPos(l10, l11, k12),
								flag1 ? Blocks.DIAMOND_BLOCK.getDefaultState().getBlock().getDefaultState() : iblockstate, 2);
					}
				}
	...
	public static class BlockCustomPortal extends BlockPortal {
		public BlockCustomPortal() {
			setHardness(-1.0F);
			setUnlocalizedName("testdim_portal");
			setRegistryName("testdim_portal");
			setLightLevel(0.25F);
		}
	...
	public static class GenLayerBiomesCustom extends GenLayer {
		private Biome[] allowedBiomes = {Biome.REGISTRY.getObject(new ResourceLocation("det:testbiome")),};
