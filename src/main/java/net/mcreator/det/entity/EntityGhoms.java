...
public class EntityGhoms extends ElementsDET.ModElement {
	public static final int ENTITYID = 3;
	public static final int ENTITYID_RANGED = 4;
	public EntityGhoms(ElementsDET instance) {
		super(instance, 8);
	}

	@Override
	public void initElements() {
		elements.entities.add(() -> EntityEntryBuilder.create().entity(EntityCustom.class).id(new ResourceLocation("det", "ghoms"), ENTITYID)
				.name("ghoms").tracker(64, 3, true).egg(-16777216, -10079488).build());
	}
		...
		RenderingRegistry.registerEntityRenderingHandler(EntityCustom.class, renderManager -> {
			return new RenderLiving(renderManager, new ModelChicken(), 0.5f) {
				protected ResourceLocation getEntityTexture(Entity entity) {
					return new ResourceLocation("det:textures/ghoms.png");
				}
			};
		});
	}
